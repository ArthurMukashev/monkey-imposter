...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $categories = collect([
            ...
            ['slug' => 'culture', 'section' => 'active', 'title' => 'Культура', 'short_description' => 'Сцены, филармония и вечерние события.', 'sort_order' => 0],
        ...
        foreach ($places as $item) {
            $place = Place::updateOrCreate(['slug' => $item['slug']], [
                ...
                'seo_canonical_path' => match ($item['section']) {
                    'active' => '/events/'.$item['slug'],
                    'tourism' => '/routes/'.$item['slug'],
                    'gastronomy' => '/gastronomy/'.$item['slug'],
                },
                'is_published' => true,
            ]);
